...
var async = require("async"),		// async module
    ...
    email = "kevin@significancelabs.org",				// your account email
    password = "km686693",			// your account password
    integratorKey = "SIGN-d22b038d-7cce-4cf9-aee8-6ef821f63d66",			// your account Integrator Key (found on Preferences -> API page)
    recipientName = "Kevin Miller",			// recipient (signer) name
    templateId = "7AC7BDBE-2CAB-429A-A0C7-203487481FE6",			// provide valid templateId from a template in your account
    templateRoleName = "SNAP Applicant",		// template role that exists on template referenced above
