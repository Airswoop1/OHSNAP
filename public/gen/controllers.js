...
angular.module('formApp.formController', [
	...
	["$scope", "$state", "$http", "$rootScope", "$upload", "$location", "$cookies", "$window", "API", "userDataFactory", "calcBenefitService", function($scope, $state, $http, $rootScope, $upload, $location, $cookies, $window, API, userDataFactory, calcBenefitService) {
